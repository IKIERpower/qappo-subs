    ...
    <AppLayout>
      <div className="p-8 space-y-10 max-w-[1400px]">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant/15 p-8 animate-fade-up delay-100">
          ...
          <div className="grid grid-cols-4 gap-0 mt-6 pt-6 border-t border-outline-variant/15">
            {[
        ...
        <div className="grid grid-cols-[320px_1fr] gap-6 animate-fade-up delay-200">
          {/* Scenarios */}
        ...
        <div className="bg-surface-container-low border border-outline-variant/10 p-8 animate-fade-up delay-300">
          ...
          <div className="grid grid-cols-[280px_1fr] gap-8 items-center">
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
