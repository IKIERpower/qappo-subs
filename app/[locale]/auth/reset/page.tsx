...
export default function ResetPage() {
    ...
    async function handleReset() {
        ...
        // Przekaż type=recovery w redirectTo — callback go odczyta z URL
        ...
        <>
            <div className="min-h-screen bg-surface flex items-center justify-center p-8">
                <div className="w-full max-w-[400px] text-center animate-fade-up">
                    ...
                    <Link href={`/${locale}/auth/login`} className="font-label text-xs uppercase tracking-widest text-on-surface-variant hover:text-on-surface transition-colors flex items-center justify-center gap-1">
        ...
        <>
            <div className="min-h-screen bg-surface flex items-center justify-center p-8">
                <div className="w-full max-w-[400px] animate-fade-up">
                    <Link href={`/${locale}/auth/login`} className="inline-flex items-center gap-1 font-label text-xs uppercase tracking-widest text-on-surface-variant hover:text-on-surface transition-colors mb-10">
