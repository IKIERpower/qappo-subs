  ...
  return (
    <AppLayout>
      <div className="flex flex-col h-full">
        {/* Toolbar */}
        <div className="px-8 py-4 border-b border-outline-variant/15 bg-surface-container-lowest flex items-center gap-4 flex-shrink-0">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 bg-surface-container-low border border-outline-variant/20 text-on-surface font-label text-sm placeholder:text-on-surface-variant focus:outline-none focus:border-primary transition-colors w-56"
            />
          </div>
          <select
            value={filterStatus}
          ...
          <div className="ml-auto font-label text-xs text-on-surface-variant">
        ...
        <div className="flex-1 overflow-auto">
          {loading ? (
            <div className="p-8 space-y-3">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="h-12 bg-surface-container-low animate-pulse" style={{ animationDelay: `${i * 80}ms` }} />
              ))}
            </div>
          ) : (
            <table className="w-full border-collapse">
              ...
              <tbody>
                {filtered.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="text-center py-16 font-label text-sm text-on-surface-variant">
