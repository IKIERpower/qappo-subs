        ...
        <AppLayout>
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10 animate-fade-up">
                ...
                <div className="flex items-center gap-2 mb-8">
                    <Link href="/subscriptions" className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant hover:text-on-surface transition-colors flex items-center gap-1">
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-2 pb-8 flex gap-2">
                        ...
                        <Link href="/subscriptions" className="px-6 py-4 border border-outline-variant/30 font-label text-[10px] uppercase tracking-widest text-on-surface-variant hover:text-on-surface hover:border-outline-variant transition-all duration-200 flex items-center whitespace-nowrap">
                            Cancel
                        </Link>
                    </div>
                </div>
